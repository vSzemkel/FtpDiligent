...
sealed class FtpDiligentOracleClient : FtpDiligentDatabaseClientBase, IFtpRepository
{
    #region fields
    /// <summary>
    ...
    protected override FtpEndpoint CreateFtpEndpoint(DataRow row) => new (new FtpEndpointModel()
    {
        ...
        protocol = (eFtpProtocol)(short)row[8],
        direction = (eFtpDirection)(short)row[9],
        mode = (eFtpTransferMode)(short)row[10]
    });
    ...
    protected override FtpSchedule CreateFtpSchedule(DataRow row) => new (new FtpScheduleModel()
    {
        ...
        name = row[2].ToString(),
        startSpan = new TimeSpan(0, minutes: (short)(decimal)row[3], 0),
        stopSpan = new TimeSpan(0, minutes: (short)(decimal)row[4], 0),
        stride = (short)(decimal)row[5],
